        ...
        <div class="row">
            ...
            <div class="col text-center-xs my-5">
                ...
                <span class="d-inline-flex align-items-center mb-4">
                    <img src="/images/logo/logo_dark.svg?v=2" class="w-100" style="max-width: 185px !important" alt="...">
                </span>

                <div class="clearfix mb-4">

                    <!-- social -->
                    <a href="#" class="btn btn-sm btn-light transition-hover-top mb-2 rounded-circle"
                ...
                <p class="m-0 text-gray-500 fs-6">
                    &copy; My Company Inc. All Rights Reserved.
                </p>
