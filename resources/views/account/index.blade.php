    ...
    <div class="card mb-4">
        <div class="card-body p-4">
            ...
            <form method="post" action="#">
                ...
                <h2 class="h4 mb-4">
                    Evaluate your experience with <strong class="text-primary">Vidaki</strong>
                </h2>

                <p class="small mb-4">
                    According to your experienceover the past few months, would you recommend us to your
                    friends and family?
                ...
                <div id="rate-overall" class="clearfix mb-3">
                    ...
                    <div class="rate-item float-start d-inline-flex me-1 mb-1">
                        <input required class="d-none-cloaked form-check-input form-check-input-primary"
                            name="feedback_rate" type="radio" value="0" id="rate-0">
                    ...
                    <div class="rate-item float-start d-inline-flex me-1 mb-1">
                        <input required class="d-none-cloaked form-check-input form-check-input-primary"
                            name="feedback_rate" type="radio" value="1" id="rate-1">
                        <label class="form-check-label cursor-pointer px-3 py-2 bg-gray-200 rounded-sm fw-bold small"
                            for="rate-1">1</label>
                    </div>
                    ...
                    <div class="rate-item float-start d-inline-flex me-1 mb-1">
                        <input required class="d-none-cloaked form-check-input form-check-input-primary"
                            name="feedback_rate" type="radio" value="2" id="rate-2">
                        <label class="form-check-label cursor-pointer px-3 py-2 bg-gray-200 rounded-sm fw-bold small"
                            for="rate-2">2</label>
                    </div>
                    ...
                    <div class="rate-item float-start d-inline-flex me-1 mb-1">
                        <input required class="d-none-cloaked form-check-input form-check-input-primary"
                            name="feedback_rate" type="radio" value="3" id="rate-3">
                        <label class="form-check-label cursor-pointer px-3 py-2 bg-gray-200 rounded-sm fw-bold small"
                            for="rate-3">3</label>
                    </div>
                    ...
                    <div class="rate-item float-start d-inline-flex me-1 mb-1">
                        <input required class="d-none-cloaked form-check-input form-check-input-primary"
                            name="feedback_rate" type="radio" value="4" id="rate-4">
                        <label class="form-check-label cursor-pointer px-3 py-2 bg-gray-200 rounded-sm fw-bold small"
                            for="rate-4">4</label>
                    </div>
                    ...
                    <div class="rate-item float-start d-inline-flex me-1 mb-1">
                        <input required class="d-none-cloaked form-check-input form-check-input-primary"
                            name="feedback_rate" type="radio" value="5" id="rate-5">
                        <label class="form-check-label cursor-pointer px-3 py-2 bg-gray-200 rounded-sm fw-bold small"
                            for="rate-5">5</label>
                    </div>
                    ...
                    <div class="rate-item float-start d-inline-flex me-1 mb-1">
                        <input required class="d-none-cloaked form-check-input form-check-input-primary"
                            name="feedback_rate" type="radio" value="6" id="rate-6">
                        <label class="form-check-label cursor-pointer px-3 py-2 bg-gray-200 rounded-sm fw-bold small"
                            for="rate-6">6</label>
                    </div>
                    ...
                    <div class="rate-item float-start d-inline-flex me-1 mb-1">
                        <input required class="d-none-cloaked form-check-input form-check-input-primary"
                            name="feedback_rate" type="radio" value="7" id="rate-7">
                        <label class="form-check-label cursor-pointer px-3 py-2 bg-gray-200 rounded-sm fw-bold small"
                            for="rate-7">7</label>
                    </div>
                    ...
                    <div class="rate-item float-start d-inline-flex me-1 mb-1">
                        <input required class="d-none-cloaked form-check-input form-check-input-primary"
                            name="feedback_rate" type="radio" value="8" id="rate-8">
                        <label class="form-check-label cursor-pointer px-3 py-2 bg-gray-200 rounded-sm fw-bold small"
                            for="rate-8">8</label>
                    </div>
                    ...
                    <div class="rate-item float-start d-inline-flex me-1 mb-1">
                        <input required class="d-none-cloaked form-check-input form-check-input-primary"
                            name="feedback_rate" type="radio" value="9" id="rate-9">
                        <label class="form-check-label cursor-pointer px-3 py-2 bg-gray-200 rounded-sm fw-bold small"
                            for="rate-9">9</label>
                    </div>
                    ...
                    <div class="rate-item float-start d-inline-flex me-1 mb-1">
                        <input required class="d-none-cloaked form-check-input form-check-input-primary"
                            name="feedback_rate" type="radio" value="10" id="rate-10">
                        <label class="form-check-label cursor-pointer px-3 py-2 bg-gray-200 rounded-sm fw-bold small"
                ...
                <textarea class="form-control my-3" rows="3" name="feedback_body"
                    placeholder="Please, leave us a short feedback"></textarea>
    ...
    <div class="card mb-4">
        <div class="card-body p-4">
            ...
            <div class="row">
                ...
                <div class="col-12 mb-4 border-top border-light d-lg-none"><!-- mobile separator -->
                </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="w-100 ps-3">
                            ...
                            <a href="account-orders.html" class="text-decoration-none small">view
                                orders</a>
                        </div>
                ...
                <div class="col-12 my-4 border-top border-light d-lg-none"><!-- mobile separator -->
                </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="w-100 ps-3">
                            ...
                            <a href="account-reviews.html" class="text-decoration-none small">view
                                reviews</a>
                        </div>
