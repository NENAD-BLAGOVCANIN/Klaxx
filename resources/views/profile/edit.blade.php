                    ...
                    <div class="card">
                        <div class="card-body p-0 p-md-4">
                            ...
                            <ul id="nav_responsive" class="nav flex-column d-none d-lg-block mt-1 mt-lg-0">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link px-0 d-flex align-items-center" href="account-settings.html">
                                        <svg class="text-gray-600 float-start" width="18px" height="18px"
                                            viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                                            <path fill-rule="evenodd"
                        ...
                        <form method="post" action="#">
                            ...
                            <div id="rate-overall" class="clearfix mb-3">
                                ...
                                <div class="rate-item float-start d-inline-flex me-1 mb-1">
                                    ...
                                    <label
                                        class="form-check-label cursor-pointer px-3 py-2 bg-gray-200 rounded-sm fw-bold small"
                                        for="rate-0">0</label>
                                </div>
