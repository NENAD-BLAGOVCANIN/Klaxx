        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-9 order-2">
                    ...
                    <div class="shadow-xs bg-white mb-5 p-3 rounded clearfix">
                        ...
                        <div class="float-end small position-relative mt-1">
                            Sort by: &nbsp; <a href="#" class="text-danger text-decoration-none"
                            ...
                            <ul class="dropdown-menu border-0 mt-3 rounded fs-6">
                                <li class="dropdown-item active"><a href="#"
                                        class="text-muted small py-2 d-block">Best Match</a></li>
                                <li class="dropdown-item"><a href="#" class="text-muted py-2 d-block small">Latest
                                        Updated</a></li>
                                <li class="dropdown-item"><a href="#" class="text-muted py-2 d-block small">Price: Low
                                        to High</a></li>
                                <li class="dropdown-item"><a href="#" class="text-muted py-2 d-block small">Price:
                                        High to Low</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="mb-5">
                        ...
                        <ul class="list-inline">
                            <li class="list-inline-item"><a href="#"
                                    class="text-danger text-decoration-none px-2">All</a></li>
                            <li class="list-inline-item"><a href="#"
                                    class="text-muted text-decoration-none px-2">Private</a></li>
                            <li class="list-inline-item"><a href="#"
                                    class="text-muted text-decoration-none px-2">Dealer</a></li>
                        </ul>
                                        ...
                                        <a href='/listings/view/{{ $listing->id }}' class="text-decoration-none">
                                            @if ($listing->images->isNotEmpty())
                                                <img class="img-fluid lazy" src="{{ $listing->images[0]->image_path }}"
                                                    alt="...">
                                            @else
                                                <img class="img-fluid lazy" src="/images/various/no-image.jpg"
                                                    alt="No Image">
                                            @endif
                                        </a>
                                    </figure>
                ...
                <div class="col-12 col-lg-3 mb-5 order-1">
                    ...
                    <!-- CATEGORIES -->
                    <nav
                        class="nav-deep nav-deep-light mb-4 shadow-xs shadow-none-md shadow-none-xs px-4 pb-3 p-0-md p-0-xs rounded">
